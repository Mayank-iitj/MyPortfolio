...
// Use public assets for easy hosting
const cardGLB = '/card.glb';
const lanyardTex = '/id-card.png';
...
// Minimal Band implementation referencing public assets
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
  ...
  useFrame((state, delta) => {
    ...
    if (fixed.current) {
      ...
      ang.copy(card.current.angvel()); rot.copy(card.current.rotation()); card.current.setAngvel({ x: ang.x, y: ang.y - rot.y * 0.25, z: ang.z });
    }
  });
