    ...
    <>
          ...
          <div className="container">
            ...
            <div className="about-text about-intro">
              <div className="about-text">
                <p>I build secure, explainable AI and data systems that convert raw signals into decision-ready insights. My work blends theory with implementation—covering model design, evaluation, and interpretable insights.</p>
                <p>I enjoy translating research into deployable, interpretable products: from expert systems and NLP utilities to security analyses like JWT hardening. Outcome-first, with guardrails and explainability.</p>
              </div>
                ...
                items={[
                  {
                    ...
                    icon: <svg className="carousel-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>                  },
                  {
                    id: 2,
                    title: 'imagine',
                    description: 'Python • Face & emotion recognition',
                    url: 'https://github.com/Mayank-iitj/imagine',
                    icon: <svg className="carousel-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="10" r="3"></circle><path d="M7 20.662V19a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1.662"></path></svg>                  },
                  {
                    id: 3,
                    title: 'virtualmouse',
                    description: 'Python • Hand-tracking virtual mouse',
                    url: 'https://github.com/Mayank-iitj/virtualmouse',
                    icon: <svg className="carousel-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="6" y="2" width="12" height="20" rx="2"></rect><circle cx="12" cy="18" r="1"></circle></svg>                  },
                  {
                    id: 4,
                    title: 'customer-churn-prediction',
                    description: 'Python • Streamlit app (live)',
                    url: 'https://customer-churn-ms.streamlit.app/',
                    icon: <svg className="carousel-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"></path><path d="M18 17V9"></path><path d="M13 17V5"></path><path d="M8 17v-3"></path></svg>                  },
                  {
                    id: 5,
                    title: 'FakeReview',
                    description: 'Python • Fake review detection (live)',
                    url: 'https://fakereview-ms.streamlit.app/',
                    icon: <svg className="carousel-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>                  }
                ]}
              />
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="cta-social">
              ...
              <a href="https://x.com/mayyankks/" target="_blank" rel="noopener noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>              </a>
              <a href="https://github.com/Mayank-iitj" target="_blank" rel="noopener noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>              </a>
            ...
            <p className="cta-email">mayyanks@gmail.com</p>
          </div>
        </section>
      </div>
      ...
      <Dock
        items={[
          ...
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.9-2-2-2zm0 13H4V8h16v11z"/></svg>, label: 'Services', onClick: () => document.querySelector('#services')?.scrollIntoView({ behavior: 'smooth' })},
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M22 16V4c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2zm-11-4l2.03 2.71L16 11l4 5H8l3-4z"/></svg>, label: 'Projects', onClick: () => document.querySelector('#projects')?.scrollIntoView({ behavior: 'smooth' })},
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>, label: 'Experience', onClick: () => document.querySelector('#experience')?.scrollIntoView({ behavior: 'smooth' })},
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>, label: 'Skills', onClick: () => document.querySelector('#skills')?.scrollIntoView({ behavior: 'smooth' })},
          ...
          { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>, label: 'Contact', onClick: () => window.location.href = '/contact'},
        ]}
        magnification={70}
        distance={200}
        panelHeight={68}
